...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="440" height="347"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="413" height="128"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="430" height="99"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="362"></svg>)

对于非替代的 inline 元素，它用于计算行框盒子的高度。此时内联元素的行框盒子的高度完全由`line-height`决定，不受其他任何属性的影响。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="228"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="349"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="331"></svg>)
...
![](https://user-gold-cdn.xitu.io/2019/7/16/16bfa565ca11c0a1?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2019/7/16/16bfa5835695a011?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
这个特性看起来很正常，因为正常的元素默认最大宽度都是包含块的宽度。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="202"></svg>)

由于这个特性，如果包含块的宽度很小，会出现一柱擎天的现象。解决方法也很简单，加个`white-space: nowrap`让文本不换行就行了：[地址](http://js.jirengu.com/jujik/1/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="328"></svg>)

*   无依赖绝对定位

大多数用到绝对定位的时候，都是存在包含块和`left/top`等方向属性的。但其实`position: absolute`是非常独立的css属性，其样式和行为表现不依赖任何css属性就可以完成。

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="265"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="251"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1046" height="370"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1114" height="569"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="464" height="301"></svg>)

1.  最底层`border/background`是当前层叠上下文元素的边框和背景色（注意不包括文字，文字相当于内联盒子）。`z-index`为负值的元素在其之上。

如下图所示，虽然 `.dad` 元素设置了 `position: relative` ，但是由于元素默认为 `z-index: auto`，并没有创建层叠上下文，此时其就是一个普通的块级盒子。所以设置了`z-index: -1`的`.son`元素跑到了爸爸身后看不见了。

而由于`.mom`设置了`z-index: 0`，创建出了一个层叠上下文，所以`.son`元素就算设置了`z-index: -1`也跑不出老妈的视线。[地址](http://js.jirengu.com/litay/1/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1011" height="306"></svg>)

2.  当块级元素和内联元素发生层叠，内联元素居于块级元素之上。如下图：[地址](http://js.jirengu.com/gafof/1/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1008" height="243"></svg>)

3.  普通定位元素层叠水平在普通元素之上。普通定位元素是指`z-index`为`auto`的定位元素。下图`span`就是普通定位元素：[地址](http://js.jirengu.com/xisoz/1/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1008" height="237"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1007" height="235"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1012" height="292"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="816" height="220"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1063" height="290"></svg>)

### `text-align: justify`（本文重点例子!）

`text-align: justify`为两端对齐（对尾行无效且子元素之间必须有空格或换行符）。除了实现文字的两端对齐，还能用来做一些两端对齐的布局。下面介绍个两端对齐布局的实例：[地址](http://js.jirengu.com/jihay/6/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1003" height="312"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1003" height="317"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1002" height="346"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1005" height="357"></svg>)
...
![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1092" height="391"></svg>)

### 弹性布局实现两端对齐尾行左对齐：[地址](http://js.jirengu.com/ribez/1/edit?html,css,output)

![](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="338"></svg>)
...
*   新增了`默认最大宽度为包含块的宽度`；(2020.3.27)
*   更新了`BFC的创建方法`；(2020.4.23)